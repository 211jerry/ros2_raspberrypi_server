...
static const _FishBotConfig_Request_type_support_symbol_names_t _FishBotConfig_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fishbot_interfaces, srv, FishBotConfig_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fishbot_interfaces, srv, FishBotConfig_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fishbot_interfaces, srv, FishBotConfig_Request)() {
  return &::fishbot_interfaces::srv::rosidl_typesupport_c::FishBotConfig_Request_message_type_support_handle;
}
...
static const _FishBotConfig_Response_type_support_symbol_names_t _FishBotConfig_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fishbot_interfaces, srv, FishBotConfig_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fishbot_interfaces, srv, FishBotConfig_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fishbot_interfaces, srv, FishBotConfig_Response)() {
  return &::fishbot_interfaces::srv::rosidl_typesupport_c::FishBotConfig_Response_message_type_support_handle;
}
...
static const _FishBotConfig_type_support_symbol_names_t _FishBotConfig_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fishbot_interfaces, srv, FishBotConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fishbot_interfaces, srv, FishBotConfig)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, fishbot_interfaces, srv, FishBotConfig)() {
  return &::fishbot_interfaces::srv::rosidl_typesupport_c::FishBotConfig_service_type_support_handle;
}
